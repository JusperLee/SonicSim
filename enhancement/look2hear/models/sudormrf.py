...
class SuDORMRF(BaseModel):
    def __init__(self,
                 ...
                 enc_num_basis=512,
                 num_sources=2):
        super(SuDORMRF, self).__init__(sample_rate=16000)
    ...
    def forward(self, input_wav):
        ...
        return self.remove_trailing_zeros(estimated_waveforms, input_wav).view(input_wav.shape[0], -1)
