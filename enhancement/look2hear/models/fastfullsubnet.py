...
class FastFullSubnet(BaseModel):
    def __init__(
        self,
        look_ahead,
        shrink_size,
    ...
    def forward(self, noisy):
        ...
        mix_mag, noisy_phase, noisy_real, noisy_imag = stft(noisy, n_fft=self.n_fft, hop_length=self.hop_length, win_length=self.win_length)
        ...
        return output, noisy_real, noisy_imag
